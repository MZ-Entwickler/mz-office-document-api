...
public final class PlaceMarkerInserter {
    ...
    /**
     * Callback wird für jeden Aufruf der {@link #replace(java.lang.String)}
     ...
     * {@link #replace(java.lang.String)}) jeweils einmalig abgerufen.
     ...
     * <br><br>
     * 
     * @param   specificPlaceMarker
     *          Callback-Klasse/Lambda für die Ersetzung der Platzhalter
     *          in einer Zeichenkette.<br>
     * 
     * @param   identifierStartDelimiter
     *          Trennzeichen die den Beginn eines Platzhalters markieren.
     *          Länge der Zeichenkette muss größer 0 sein.<br>
     * 
     * @param   identifierEndDelimiter 
     *          Trennzeichen die das Ende eines Platzhalters markieren.
     *          Länge der Zeichenkette muss größer 0 sein.<br>
     */
     ...
     * 
     * @param   specificPlaceMarker
     *          Callback-Klasse/Lambda für die Einsetzung der Platzhalter
    ...
    private String fillPlaceHolders(
        ...
        @Nullable
        final Map<String, String> localPlaceMarker;
     ...
     *          Falls ein Platzhalter nicht gefunden wurde oder wenn das Ende
     *          eines Platzhalters nicht erkennbar/gefunden ist/wurde.<br>
     * 
     * @throws  NullPointerException
     *          Im Falle das {@code specificPlaceMarker#get() == null} ist.
     */
     ...
     * 
     * @throws  IllegalStateException
     *          Falls ein Platzhalter nicht gefunden wurde (nur wenn
