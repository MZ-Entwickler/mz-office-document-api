...
public abstract class MicrosoftInsertDoc implements Extension {
    ...
    ate
    static final ExtendedValue EMPTY_INSERTION = new EmptyAltChunkExtValue();
    ...
    {
        @code 'word/_rels/document.xml.rels'
    }
    ...
    Sucht an
    der Stelle
    des Platzhalter-Nodes,
    in den
    höherwertigen Parent-
    Nodes nach
    einem
     *
    passenden Elternelement
    für w:altChunk .
     *
             * <pre>
     *
    ...
    AUSGABE(w:p kann mit w:altChunk getauscht werden)
     *w:r
     *w:fldChar
     *w:r
     *w:instrText         &lt;----EINGABE
  ...
  *
    ...
    createAltChunkElement(String chunkID) {
...
private static class AltChunkExtValue extends ExtendedValue {
     ...
     * @throws UncheckedIOException Gewrappte IOException bei einem Ein-/Ausgabefehler.
     */
