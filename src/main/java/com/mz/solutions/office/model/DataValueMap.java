...
public interface DataValueMap<TReturnInstance> {
     ...
     * @throws DataValueKeyNameAlreadyExistsException Wenn der Platzhalterbezeichner bereits vergeben/ belegt ist.
     */
     ...
     * @return Gibt die eigene Instanz zurück
     * @throws DataValueKeyNameAlreadyExistsException Wenn einer der übergebenen Platzhalter einen Bezeichner
