...
public abstract class OfficeDocument {
     ...
     * @throws IOException             Darf frei geworfen werden.
     * @throws OfficeDocumentException Für Fehler die nicht IO basiert sind, sondern entweder im
     ...
     *                     sollen, soweit unterstützt. Nicht unterstützte Anwensungen werden von
     *                     der Implementierung ignoriert.
     * @throws UncheckedIOException    Sollte beim Schreibvorgang durch {@code docResult} ein IO Fehler
     *                                 auftreten, wird dies als {@code unchecked} Exception
     *                                 weiter gereicht.
     * @throws OfficeDocumentException Tritt auf wenn Fehler beim Ersetzungsvorgang oder der Erstellung
