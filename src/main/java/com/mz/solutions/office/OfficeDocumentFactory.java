...
import static com.mz.solutions.office.resources.OfficeDocumentFactoryKeys.INVALID_PROP_VALUE;
import static com.mz.solutions.office.resources.OfficeDocumentFactoryKeys.NO_PROPERTY;
...
public abstract class OfficeDocumentFactory {
     ...
     *
     * @param officeFactoryConstructor Konstruktor-Funktion zur Erstellung einer Factory-Instanz der
     ...
     * @return Dokument
     * @throws UncheckedIOException    Im Falle eines I/O Fehlers (z.B. beim Öffnen
     *                                 des Dokumentes).
     * @throws OfficeDocumentException Wirft Unterklassen dieser Exception um Fehler beim
