...
import com.mz.solutions.office.resources.MicrosoftDocumentKeys;
import org.w3c.dom.*;
...
import static com.mz.solutions.office.resources.MicrosoftDocumentKeys.UNKNOWN_FORMATTING_CHAR;
    ...
    private List<Node> createFormattedNodes(
        ...
        for (char ch : textContent.toCharArray()) {
            ...
            switch (ch) {
                ...
                case '\t':
                    formattedNodes.add(document.createElement("w:tab"));
                    break;
